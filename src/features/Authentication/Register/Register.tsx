...
import { Eye, EyeOff, Briefcase, UserCircle, ArrowLeft, Mail, Lock, MapPin, Building, User } from "lucide-react"
              ...
              >
                <CardContent className="p-8">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      <h3 className="text-2xl font-semibold text-blue-900 group-hover:text-purple-900 transition-colors">I&apos;m an Employer</h3>
                      <p className="text-blue-600 group-hover:text-purple-600 transition-colors text-lg">Looking to hire top talent</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
              ...
              >
                <CardContent className="p-8">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      <h3 className="text-2xl font-semibold text-blue-900 group-hover:text-purple-900 transition-colors">I&apos;m a Job Seeker</h3>
                      <p className="text-blue-600 group-hover:text-purple-600 transition-colors text-lg">Exploring new opportunities</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="space-y-2">
                  <Label htmlFor="firstName" className="text-blue-900 text-lg">
                    First name
                  </Label>
                ...
                <div className="space-y-2">
                  <Label htmlFor="lastName" className="text-blue-900 text-lg">
                    Last name
                  </Label>
                  <div className="relative">
                    <User className="absolute left-3 top-1/2 transform -translate-y-1/2 text-blue-500 h-6 w-6" />
              ...
              {userType === "jobseeker" && (
                <div className="space-y-2">
                  <Label htmlFor="jobTitle" className="text-blue-900 text-lg">
                    Current Job Title
                  </Label>
                  <div className="relative">
              ...
              {userType === "employer" && (
                <div className="space-y-2">
                  <Label htmlFor="companyName" className="text-blue-900 text-lg">
                    Company Name
                  </Label>
                  <div className="relative">
                    <Building className="absolute left-3 top-1/2 transform -translate-y-1/2 text-blue-500 h-6 w-6" />
                    <Input
                      id="companyName"
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-3">
                  <Checkbox id="newsletter" {...register("newsletter")} className="text-blue-500 border-blue-200 h-5 w-5" />
                  <Label
                    htmlFor="newsletter"
                ...
                <div className="flex items-center space-x-3">
                  <Checkbox id="terms" {...register("terms", { required: "You must agree to the terms" })} className="text-blue-500 border-blue-200 h-5 w-5" />
                  <Label
                    htmlFor="terms"
                    className="text-blue-700 text-base leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70"
                  >
                    I agree to the CareerConnect{" "}
